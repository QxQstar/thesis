...
<div class="g-main f-show f-main-bg f-paddBtm-60 ">
    ...
    <div class="m-search f-marTop-30 f-area-bg f-center f-clearfix">
        ...
        <div class="info f-float-l">
            ...
            <h1 class="on"><a href="/thesis/src/PHP/show/adminZPall.php">全部作品</a> </h1>
        </div>
    </div>

    <!-- 作品列表-->
    {if $length gt 0}
        <ul class="m-list f-marTop-30  f-center" id="list" data-status="all" data-search="%%" data-role="admin" data-maxPage="{$maxpage}">
